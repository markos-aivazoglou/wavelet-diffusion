...
from .kan_utils.fastkanconv import FastKANConvLayer, SplineConv2D
...
class UNet_ConvKan(nn.Module):
    def __init__(self, in_channels, T, ch, ch_mult, attn, num_res_blocks, dropout):
        super().__init__()
        ...
        self.tail = nn.Sequential(
            ...
            FastKANConvLayer(now_ch, in_channels, 3, stride=1, padding=1),
        )
