...
class DWT_2D(Module):
    ...
    def get_matrix(self):
        ...
        if torch.cuda.is_available():
            ...
            self.matrix_low_0 = torch.Tensor(matrix_h_0).to("mps")
            self.matrix_low_1 = torch.Tensor(matrix_h_1).to("mps")
            self.matrix_high_0 = torch.Tensor(matrix_g_0).to("mps")
            self.matrix_high_1 = torch.Tensor(matrix_g_1).to("mps")
        else:
            self.matrix_low_0 = torch.Tensor(matrix_h_0)
            self.matrix_low_1 = torch.Tensor(matrix_h_1)
            self.matrix_high_0 = torch.Tensor(matrix_g_0)
...
class DWT_3D(Module):
    ...
    def get_matrix(self):
        ...
        matrix_h_2 = matrix_h[
            0 : (math.floor(self.input_depth / 2)),
        ...
        matrix_g_2 = matrix_g[
            0 : (self.input_depth - math.floor(self.input_depth / 2)),
            0 : (self.input_depth + self.band_length - 2),
        ]
